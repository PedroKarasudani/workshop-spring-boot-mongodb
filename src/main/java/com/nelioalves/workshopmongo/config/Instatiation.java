...
public class Instatiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"),"Partiu viajem", "Vou viajar para São Paulo. Abracos!", new AuthorDTO(maria));
        ...
        CommentDTO c3 = new CommentDTO("Tenha um otimo dia!", sdf.parse("22/02/2018"), new AuthorDTO(alex));
